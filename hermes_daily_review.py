...
# 分析提示词
prompt = f"""
你系一个专业嘅量化交易分析师。请根据以下交易数据，对今日 (2026-04-15) 嘅交易操作进行深度复盘分析。
...
try:
    print("[INFO] 正在调用 Hermes AI 网关进行分析...")
    print(f"[INFO] 目标地址：{url}")
    ...
    print("[ERROR] 请检查 Hermes AI 网关是否运行正常 (端口 8644)")
